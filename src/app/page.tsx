...
export default function Home() {
  ...
  return (
    <main className="relative h-screen w-screen overflow-hidden bg-black">
      ...
      <div className="fixed bottom-0 left-4 z-[120] md:bottom-6 md:left-6">
        <a
          href="https://b-average.com"
          target="_blank"
          rel="noreferrer"
          className="inline-block bg-black px-3 py-1.5 text-[9px] font-semibold uppercase tracking-[0.18em] text-white shadow-[0_4px_12px_rgba(0,0,0,0.45)] transition hover:bg-white hover:text-black md:px-2 md:py-1 md:text-xs"
        >
          B Average
        </a>
      </div>
